...
SYNTH_DUMMY_CLASS(UIControl_MLAdd)

static const int block_key;

@interface _MLUIControlBlockTarget : NSObject
...
@implementation _MLUIControlBlockTarget
...
- (void)removeAllTargets {
    ...
    [[self ____allUIControlBlockTargets] removeAllObjects];
}
...
- (void)addBlockForControlEvents:(UIControlEvents)controlEvents
    ...
    _MLUIControlBlockTarget *target = [[_MLUIControlBlockTarget alloc]
                                       initWithBlock:block events:controlEvents];
    [self addTarget:target action:@selector(invoke:) forControlEvents:controlEvents];
    NSMutableArray *targets = [self ____allUIControlBlockTargets];
...
- (void)removeAllBlocksForControlEvents:(UIControlEvents)controlEvents {
    ...
    for (_MLUIControlBlockTarget *target in targets) {
...
- (NSMutableArray *)____allUIControlBlockTargets {
