...
@property (nonatomic, readonly) NSString *chineseWeekday;///< Weekday component "星期一，星期二，星期三..."
...
/**
 Returns a string representing this date in @"yyyy-MM-dd" format.
 e.g. "2010-07-09"
 
 @return NSString representing the formatted date string in @"yyyy-MM-dd".
 */
- (nullable NSString*)stringWithGeneralDayFormat;

/**
 Returns a string representing this date in @"yyyy-MM-dd HH:mm:ss" format.
 e.g. "2010-07-09 16:13:30"
 
 @return NSString representing the formatted date string in @"yyyy-MM-dd HH:mm:ss".
 */
- (nullable NSString*)stringWithGeneralTimeFormat;
...
/**
 Returns a date parsed from given string interpreted using the @"yyyy-MM-dd" format.
 
 @param dateString The date string in @"yyyy-MM-dd" format. e.g. "2010-07-09"
 
 @return A date representation of string interpreted using the format.
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)dateWithGeneralDayFormatString:(NSString *)dateString;

/**
 Returns a date parsed from given string interpreted using the @"yyyy-MM-dd HH:mm:ss" format.
 
 @param dateString The date string in @"yyyy-MM-dd HH:mm:ss" format. e.g. "2010-07-09 16:13:30"
 
 @return A date representation of string interpreted using the format.
 If can not parse the string, returns nil.
 */
+ (nullable NSDate *)dateWithGeneralTimeFormatString:(NSString *)dateString;

#pragma mark - Date Compare
/**
 Returns a count representing the year interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the year interval between two dates
 */
+ (NSInteger)yearsBetweenDate:(NSDate*)fromDateTime withDate:(NSDate*)toDateTime;

/**
 Returns a count representing the month interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the month interval between two dates
 */
+ (NSInteger)monthsBetweenDate:(NSDate*)fromDateTime withDate:(NSDate*)toDateTime;
/**
 Returns a count representing the week interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the week interval between two dates
 */
+ (NSInteger)weeksBetweenDate:(NSDate*)fromDateTime withDate:(NSDate*)toDateTime;

/**
 Returns a count representing the day interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the day interval between two dates
 */
+ (NSInteger)daysBetweenDate:(NSDate*)fromDateTime withDate:(NSDate*)toDateTime;

/**
 Returns a count representing the hour interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the hour interval between two dates
 */
+ (NSInteger)hoursBetweenDate:(NSDate*)fromDateTime withDate:(NSDate*)toDateTime;

/**
 Returns a count representing the minute interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the minute interval between two dates
 */
+ (NSInteger)minutesBetweenDate:(NSDate*)fromDateTime withDate:(NSDate*)toDateTime;

/**
 Returns a count representing the second interval between two dates
 
 @param fromDateTime date1
 @param toDateTime   date2
 
 @return the second interval between two dates
 */
